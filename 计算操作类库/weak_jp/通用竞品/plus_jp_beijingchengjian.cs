...
namespace Calculation.JS
{
    ...
    /// 北京城建
    /// </summary>
    public class plus_jp_beijingchengjian : plus_jp_base
    {
        public ISlideCollection _plus_jp_beijingchengjian_1(string str, int cjbh)
        {
            try
            {
                ...
                foreach (var item in param)
                {
                    ...
                    if (item.jpxmlb != null && item.jpxmlb.Count > 0)
                    {
                        ...
                        Office_Tables.SetJP_RUIAN_JPBX_Table(page2, dt, 0, null, null);
                        t.AddClone(page2);
                    }
