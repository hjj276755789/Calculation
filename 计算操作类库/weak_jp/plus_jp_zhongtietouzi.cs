...
namespace Calculation.JS
{
    ...
    /// 中铁投资
    /// </summary>
    public class plus_jp_zhongtietouzi:plus_jp_base
    {
        public ISlideCollection _plus_jp_zhongtietouzi_1(string str, int cjbh)
        {
            try
            {
                ...
                foreach (var item in param)
                {
                    ...
                    if (item.jpxmlb != null && item.jpxmlb.Count > 0)
                    {
                        ...
                        Office_Tables.SetJP_ZhongTieTouZi_JPBX_Table(page1, dt, 1, null, null);
                        t.AddClone(page1);
                    }
                }
                return t;
