...
{
    public class plus_jp_chongqing18tixiangmu : plus_jp_base
    {
        public ISlideCollection _plus_jp_chongqing18tixiangmu_1(string str, int cjbh)
        {
            try
            {
                ...
                foreach (var item in param)
                {
                    ...
                    dt2_0.Columns.Add("套内面积");
                    dt2_0.Columns.Add("建筑面积");
                    ...
                    dt1.Columns.Add("预计加推时间");
                    dt1.Columns.Add("预计推出套数");
                    dt1.Columns.Add("预计建面价格");
                    dt1.Columns.Add("主力建筑面积");
                    dt1.Columns.Add("备注");
                    if (item.jpxmlb != null && item.jpxmlb.Count > 0)
                    {
