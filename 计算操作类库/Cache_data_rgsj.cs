...
namespace Calculation.JS
{
    public class Cache_data_rgsj
    {
        ...
        //        by = ZB_Data_RGSJ_DataProvider.GET_YB(Base_date.by_First, Base_date.by_Last);
        ...
        public static Cache_data_cjjl ini_zb()
        {
            ...
            {
                uniqueInstance = new Cache_data_cjjl();
                jbz = ZB_Data_RGSJ_DataProvider.GET_JBZ(Base_date.bz);
