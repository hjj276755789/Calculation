...
{
    public static class Office_ModifyInMemory
    {
        ...
        {
            MethodInfo miLicensed1 = typeof(Office_ModifyInMemory).GetMethod("InvokeMe1", BindingFlags.NonPublic | BindingFlags.Static);
            MethodInfo miLicensed2 = typeof(Office_ModifyInMemory).GetMethod("InvokeMe2", BindingFlags.NonPublic | BindingFlags.Static);
